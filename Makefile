...
pkgdatadir = $(datadir)/tio
pkgincludedir = $(includedir)/tio
pkglibdir = $(libdir)/tio
pkglibexecdir = $(libexecdir)/tio
...
CONFIG_CLEAN_FILES = src/bash-completion/tio
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(top_srcdir)/src/bash-completion/tio.in \
	$(top_srcdir)/src/include/config.h.in AUTHORS COPYING \
	ChangeLog INSTALL README compile depcomp install-sh missing
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/nordik/tio-1.32/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = tio
PACKAGE_BUGREPORT = 
PACKAGE_NAME = tio
PACKAGE_STRING = tio 1.32
PACKAGE_TARNAME = tio
...
STRIP = 
VERSION = 1.32
abs_builddir = /home/nordik/tio-1.32
abs_srcdir = /home/nordik/tio-1.32
abs_top_builddir = /home/nordik/tio-1.32
abs_top_srcdir = /home/nordik/tio-1.32
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/nordik/tio-1.32/install-sh
...
src/bash-completion/tio: $(top_builddir)/config.status $(top_srcdir)/src/bash-completion/tio.in
