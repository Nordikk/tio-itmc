...
{
    printf("tio itmc version \n");
    printf("\n");
    printf("Usage: %s [<options>] <tty-device>\n", argv[0]);
    printf("\n");
    printf("Options:\n");
    printf("  -b, --baudrate <bps>        Baud rate (default: 9600)\n");
    ...
    printf("\n");
    printf("In session, press ctrl-y q to quit.\n");
    printf("\n");
}
...
void parse_options(int argc, char *argv[])
{
    ...
    while (1)
    {
        ...
        switch (c)
        {
            ...
            case 'v':
                printf("tio v1.32 (itmc)\n");
                printf("\n");
                printf("Copyright (c) 2014-2018 Martin Lund\n");
                printf("\n");
                printf("Modified for itmc by Leon Wöste (leon.woeste@tu-dortmund.de)\n");
                printf("\n");
